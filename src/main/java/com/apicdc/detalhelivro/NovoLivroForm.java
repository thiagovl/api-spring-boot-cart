...
public class NovoLivroForm {
	...
	private String isbn;
	@NotNull
	private MultipartFile capa; // Recebe upload do formulário
	@NotNull
	...
	public Livro novoLivro(AutorRepository autorRepository, Uploader uploader) {
		...
		return new Livro(titulo, subTitulo, preco, conteudo, sumario, numeroPaginas, isbn, "http://s3/capaLivro", autor);
	}	
